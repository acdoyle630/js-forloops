...
var siestaTime = [false, false, true, false, true, true];
...
function copyArray (orginArray, destinationArray){
	for (var i=0; i<orginArray.length; i++){
		destinationArray.push (orginArray [i]);
	}
}
copyArray (valuesArray, destinationArray);
